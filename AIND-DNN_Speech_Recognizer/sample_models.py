...
<head>
    ...
    <title>sample_models.py (editing)</title>
...
<link rel="stylesheet" href="/static/components/codemirror/addon/dialog/dialog.css?v=c89dce10b44d2882a024e7befc2b63f5">
    ...
    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/840AA10E-CD7B-9041-BDFA-CD665C6AD997/main.js" charset="UTF-8"></script><script src="/static/components/es6-promise/promise.min.js?v=f004a16cb856e0ff11781d01ec5ca8fe" type="text/javascript" charset="utf-8"></script>
...
data-base-url="/"
data-file-path="sample_models.py"
